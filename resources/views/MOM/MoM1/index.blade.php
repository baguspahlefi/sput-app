                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form class="d-inline" action="{{ route('MoM1.destroy', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('Apakah anda yakin menghapusnya?')">
                                        @csrf
                                        @method('DELETE')
                                                    ...
                                                    @foreach($item->daftar_hadir as $daftar_hadir)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3 text-center">
                                                                <a href="{{route('daftarHadir1.destroy', ['id' => $daftar_hadir->id])}}" ><img src="{{url('assets/icon/delete.png')}}" width="32" alt=""></a>
                                                            </div>
                                                        </div>
                                                    @endforeach
