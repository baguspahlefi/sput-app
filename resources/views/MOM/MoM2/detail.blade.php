            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 mt-4 mb-2">
                        ...
                        <button type="button" class="btn btn-success" style="float: right" data-bs-toggle="modal" data-bs-target="#exampleModalImport">
                         ...
                         <div class="modal fade" id="exampleModalImport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form method="post" action="{{route('MoM2.uploadExcel',$item->id)}}" enctype="multipart/form-data">
                        ...
                        <a class="btn btn-success me-2" style="float: right" href="{{route('MoM2.formatExcel',$item->id)}}">
                            Download Format
                        </a>
                        @endrole
                                        ...
                                        <td>
                                            ...
                                            @if($loop->first)
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalEvidance{{$detail->id}}">
                                                    <img src="{{('http://localhost/sput-app/storage/app/public').'/'.$gambarTabel->path_gambar}}" alt="" width="200" class="img-thumbnail">
                                                </a>
                                            @endif
                                            @endforeach
                                        </td>
                                    ...
                                    <div class="modal fade" id="exampleModalEdit-{{$detail->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('detail2.update',$detail->id)}}" method="post" class="row g-3" >
                                                        @csrf 
                                                        @method('PUT')
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <form action="{{route('detail2.store_evidance')}}" id="submit-form" method="POST" enctype="multipart/form-data" class="row g-3 mt-2">
                                                                @csrf
                                                                <div class="row" hidden>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <input class="form-control" id="id" name="id_detaillvl2" type="text" value="{{$detail->id}}" placeholder="Default input" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-6">
                                                    ...
                                                    <hr>
                                                    @foreach($detail->evidance_level_2 as $evidance)
                                                    <div class="row mt-4">
                                                        <div class="col-4">
                                                            <p>{{$evidance->nama_gambar}}</p>
                                                        </div>
                                                        <div class="col-4">
                                                            <img src="{{('http://localhost/sput-app/storage/app/public').'/'.$evidance->path_gambar}}" class="d-block w-100" alt="...">
                                                        </div>
                                                        ...
                                                        <button class="carousel-button next" data-carousel-button="next">&#8658;</button>
                                                            ...
                                                            @foreach($detail->evidance_level_2 as $img)
                                                                <li class="slide" {{ $key == 0 ? 'data-active' : '' }}>
                                                                        <img src="{{('http://localhost/sput-app/storage/app/public').'/'.$img->path_gambar}}" alt="Nature Image #1">
                                                                </li>
                                                            @endforeach
                                                            </ul>
                                                        </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('detail2.store')}}" method="post" class="row g-3" >
                                    @csrf 
                                    <div class="col-6 d-none">
                                        <input class="form-control" type="text" id="id" name="id" value="{{$item->id}}" placeholder="Default input" aria-label="default input example">
                                    </div>
                                    <div class="col-6">
                                        <p class="fs-5 my-auto mx-auto">Point Of Meeting {{$item->id}}</p>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group">
