                    ...
                    <table class="table" id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('detail2.index',$item->id)}}"><img src="{{url('assets/icon/detail.png')}}" width="32" alt=""></a>
                                    @role('ADMIN')
                                    ...
                                    <form class="d-inline" action="{{ route('MoM2.destroy', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('Apakah anda yakin menghapusnya?')>
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="modal fade" id="exampleModalEdit-{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <form action="{{route('MoM2.update',$item->id)}}" id="submit-form" method="POST" enctype="multipart/form-data" class="row g-3 mt-2">
                                            @csrf
                                            @method('PUT')
                                                <div class="col-6">
                                                    <p class="fs-5 my-auto mx-auto">Judul</p>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3">
                                                            <h5 class="text-center">Departement</h5>
                                                        </div>
                                                        <div class="col-3">
                                                    ...
                                                    @foreach($item->daftar_hadir_2 as $daftar_hadir)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3 text-center">
                                                                <a href="{{route('daftarHadir2.destroy', ['id' => $daftar_hadir->id])}}" ><img src="{{url('assets/icon/delete.png')}}" width="32" alt=""></a>
                                                            </div>
                                                        </div>
                                                    @endforeach
